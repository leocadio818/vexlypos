    ...
    <div className="h-full flex flex-col" data-testid="settings-page">
      ...
      <div className="flex-1 p-4 overflow-auto">
        <Tabs value={mainTab} onValueChange={setMainTab} className="max-w-4xl mx-auto">
          ...
          {/* ═══════════════════════════════════════════════════════════════
              IMPUESTOS - Gestión de Configuración de Impuestos
          ═══════════════════════════════════════════════════════════════ */}
          <TabsContent value="taxes" data-testid="taxes-content">
          ...
          {/* ═══════════════════════════════════════════════════════════════
              NCF - Gestión de Comprobantes Fiscales DGII
          ═══════════════════════════════════════════════════════════════ */}
          <TabsContent value="ncf" data-testid="ncf-content">
            <div className="space-y-6">
              {/* Header */}
              <div className="flex items-center justify-between">
                <div>
