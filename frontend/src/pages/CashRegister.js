...
import { CircleDollarSign, Play, Square, Clock, Banknote, CreditCard, AlertTriangle, TrendingUp, ArrowDownCircle, ArrowUpCircle, History, Wallet, CheckCircle2, Calculator, Coins, Receipt, RefreshCw, FileX, Search, Printer, X, Calendar, Lock, KeyRound } from 'lucide-react';
      ...
      <Dialog open={closeDialog} onOpenChange={setCloseDialog}>
        <DialogContent className="max-w-2xl backdrop-blur-xl bg-slate-900/90 border-white/20 max-h-[90vh] overflow-y-auto" data-testid="close-session-dialog">
          ...
          <div className="space-y-6">
            ...
            {/* Teclado Flotante Numerico */}
            {floatingKeypad.open && (
              <div className="fixed inset-0 z-[100] flex items-end justify-center" onClick={() => {
                ...
                <div 
                  ...
                  style={{ background: 'rgba(15,15,30,0.95)', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 -8px 40px rgba(0,0,0,0.5), 0 0 30px rgba(138,43,226,0.08)' }}
        ...
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-4 duration-300">
          <div className="backdrop-blur-xl bg-slate-900/95 border border-orange-500/30 rounded-2xl p-4 shadow-2xl shadow-orange-500/20 flex items-center gap-4">
            <div className="flex-1 min-w-0">
              <p className="text-white font-semibold text-sm truncate">{selectedMovement.description}</p>
