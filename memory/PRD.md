...
## URLs del Sistema
- **App:** https://billing-grid-desktop.preview.emergentagent.com
- **API:** https://billing-grid-desktop.preview.emergentagent.com/api
- **Agente Python:** https://billing-grid-desktop.preview.emergentagent.com/api/download/print-agent?printer_name=RECIBO
- **Instalador Servicio:** https://billing-grid-desktop.preview.emergentagent.com/api/download/print-agent-installer?printer_name=RECIBO
...
- [x] **Buscador inteligente en selector de ingredientes de recetas** (Feb 2026) - Reemplazado `<select>` basico por componente `IngredientSearchSelect` con filtro por nombre. Usa React Portal (`createPortal`) para renderizar el dropdown fuera del dialogo y evitar recorte por overflow. Resultados muestran nombre + unidad.
