...
## URLs del Sistema
- **App:** https://fiscal-invoice-fix.preview.emergentagent.com
- **API:** https://fiscal-invoice-fix.preview.emergentagent.com/api
- **Agente Python:** https://fiscal-invoice-fix.preview.emergentagent.com/api/download/print-agent?printer_name=RECIBO
- **Instalador Servicio:** https://fiscal-invoice-fix.preview.emergentagent.com/api/download/print-agent-installer?printer_name=RECIBO
