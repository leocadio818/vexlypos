...
from routers.taxes import router as taxes_router, set_db as taxes_set_db
...
async def download_print_agent(printer_name: str = Query("Caja", description="Nombre de la impresora en Windows")):
    ...
    server_url = os.environ.get('REACT_APP_BACKEND_URL', 'https://printer-template-dev.preview.emergentagent.com')
